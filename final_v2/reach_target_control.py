...
class GUINode(Node):
    ...
    def __init__(self, name, initvalue, rate):
        ...
        quality = QoSProfile(durability=DurabilityPolicy.TRANSIENT_LOCAL,
                             depth=1)
        self.pub = self.create_publisher(Bool, '/reach', quality)
    ...
    def run(self):
        ...
        app.setApplicationDisplayName("Reach Target Control GUI")
